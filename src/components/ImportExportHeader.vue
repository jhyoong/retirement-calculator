<template>
  <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
    <button
      @click="handleExport"
      class="bg-blue-600 hover:bg-blue-700 text-white text-xs sm:text-sm font-medium py-2 px-3 sm:px-4 rounded-md transition-colors"
    ...
    <button
      ...
      class="bg-green-600 hover:bg-green-700 text-white text-xs sm:text-sm font-medium py-2 px-3 sm:px-4 rounded-md transition-colors"
    ...
    <button
      @click="handleClear"
      class="bg-red-600 hover:bg-red-700 text-white text-xs sm:text-sm font-medium py-2 px-3 sm:px-4 rounded-md transition-colors"
    ...
    <p v-if="message" class="text-xs sm:text-sm text-center sm:text-left sm:ml-2" :class="messageClass">
      {{ message }}
    </p>
  </div>
</template>
